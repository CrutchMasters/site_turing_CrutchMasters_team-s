            ...
            <div className="max-w-2xl space-y-6">
              ...
              {isSuperAdmin && !isOwnProfile && (
                <section className="bg-(--card) rounded-2xl sm:rounded-[2.5rem] shadow-sm border border-red-500/30 p-6 sm:p-8">
                    ...
                    {ROLES.map(role => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl font-black text-[10px] uppercase tracking-widest border transition-all ${
                          selectedRole === role
                            ? roleBadgeColor[role] + " border-current scale-105"
                  ...
                  {roleMsg && (
                    <p className={`mt-3 text-[10px] font-black uppercase tracking-widest ${roleMsg.type === "ok" ? "text-green-500" : "text-red-500"}`}>
                      {roleMsg.text}
                    </p>
                  )}
                </section>
