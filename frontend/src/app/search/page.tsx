...
export default function SearchPage() {
  ...
  return (
    ...
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 lg:p-10 relative z-10"><div className="max-w-4xl mx-auto">
    ...
    <div className="bg-(--card) rounded-2xl sm:rounded-[2.5rem] shadow-xl border border-(--brd) p-8 sm:p-10">
    ...
    {hasSearched && (
      ...
      {isSearching ? (
        ...
        <div className="bg-(--card) rounded-2xl sm:rounded-[2.5rem] p-10 sm:p-14 border border-(--brd) text-center">
        ...
        {searchResults.map((person, idx) => (
          ...
          className="fuIn bg-(--card) rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 border border-(--brd) hover:border-blue-600/50 cursor-pointer transition-all hover:shadow-lg hover:shadow-blue-600/10 group"
          style={{ animationDelay: `${idx * 50}ms` }}
          >
          <div className="flex items-start gap-4">
          {/* ✅ Avatar with photo */}
          <div className="w-14 h-14 rounded-full bg-blue-600/10 border-2 border-(--brd) flex-shrink-0 overflow-hidden flex items-center justify-center font-black text-blue-600 text-lg">
          {person.avatar_url ? (
    ...
    {!hasSearched && (
      <div className="bg-(--card) rounded-2xl sm:rounded-[2.5rem] p-14 sm:p-20 border border-(--brd) text-center">
