...
export default function UserProfile() {
  ...
  return (
    ...
    <style jsx global>{`
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-40 lg:hidden" onClick={() => { setIsSidebarOpen(false); setIsSettingsPanelOpen(false); }} />
      )}
      ...
      onClick={() => setIsSettingsPanelOpen((p) => !p)}
      />
