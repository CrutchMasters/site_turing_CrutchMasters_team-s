...
export default function UserProfile() {
  ...
  return (
    ...
    <span className="text-(--t2)">Ім'я:</span> <span className="font-bold">{user.username}</span>
    </p>
    <p className="flex items-center gap-3 font-medium">
    <User size={16} className="text-blue-600 flex-shrink-0"/>
    <span className="text-(--t2)">Логін:</span> <span className="font-bold">{user.login}</span>
    </p>
    <p className="flex items-center gap-3 font-medium">
    <Mail size={16} className="text-blue-600 flex-shrink-0"/>
    <span className="text-(--t2)">Email:</span> <span className="font-bold break-all">{user.email}</span>
    </p>
    <p className="flex items-center gap-3 font-bold text-blue-600">
    <Shield size={16} className="flex-shrink-0"/>
    <span>Роль:</span> <span className="uppercase tracking-wider">{user.role}</span>
    </p>
    </div>
    </div>
