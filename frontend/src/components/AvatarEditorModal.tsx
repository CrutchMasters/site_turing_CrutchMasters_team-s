...
export default function AvatarEditorModal({ userId, onSave, onClose, supabase }: Props) {
    ...
    return (
        ...
        {!img ? (
            ...
            <div className="w-14 h-14 rounded-2xl bg-blue-600/10 border border-blue-600/20 flex items-center justify-center text-3xl">
            🖼️
            </div>
            ...
            <p className="text-[10px] text-(--t2) font-bold">
            Перетягни · Колесо миші = масштаб
            </p>
            </div>
            ...
            className="flex-1 h-9 rounded-xl border border-(--brd) text-(--t2) text-xs font-black hover:border-blue-600/40 hover:text-blue-600 transition-all active:scale-95">
            ↺ −90°
            </button>
