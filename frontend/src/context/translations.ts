...
const def = {
  en: {
    ...
    teams: {
      ...
      orgLabel: "City / School / Organization",
      orgPlaceholder: "e.g. Kyiv, School #42",
      ...
      confirmRemoveHint: "Remove",
      confirmRemoveFrom: "from the team?",
  ...
  ru: {
    ...
    teams: {
      ...
      telegram: "Telegram",
      discord: "Discord",
      myTeamBadge: "Моя команда",
      editTitle: "Редактирование команды",
      basicInfo: "Основная информация",
      nameLabel: "Название команды",
      namePlaceholder: "Введите название команды",
      orgLabel: "Город / Школа / Организация",
      orgPlaceholder: "Напр. Москва, Школа №42",
      telegramLabel: "Telegram",
      discordLabel: "Discord",
      ...
      confirmRemove: "Удалить участника?",
      confirmRemoveHint: "Удалить",
      confirmRemoveFrom: "из команды?",
  ...
  ua: {
    ...
    teams: {
      ...
      backToList: "← До списку команд",
      telegram: "Telegram",
      discord: "Discord",
      myTeamBadge: "Моя команда",
      editTitle: "Редагування команди",
      basicInfo: "Основная інформація",
      nameLabel: "Назва команди",
      namePlaceholder: "Введіть назву команди",
      orgLabel: "Місто / Школа / Організація",
      orgPlaceholder: "Напр. Київ, Школа №42",
      telegramLabel: "Telegram",
      discordLabel: "Discord",
      ...
      confirmRemove: "Видалити учасника?",
      confirmRemoveHint: "Видалити",
      confirmRemoveFrom: "з команди?",
      backToTeam: "Повернутись до команди",
      membersOf: "/10",
      noMembers: "Учасників ще немає",
      searchEmpty: "Нікого не знайдено",
      addBtn: "Додати",
